...
import ReactionSelector from './cursor/reaction/ReactionButton';
import FlyingReaction from './cursor/reaction/FlyingReaction';
...
useEffect(()=>{
  ...
  return ( 
    ...
    >
       <h1 className="text-3xl text-white font-mono">Live Blocks Ligma. press " / "</h1>

       {reaction.map((r) => {
          return (
            <FlyingReaction
              key={r.timestamp ? r.timestamp.toString() : ''}
              x={r.point.x}
              y={r.point.y}
